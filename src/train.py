...
class ProjectAgent:
    def act(self, observation, use_random=False):
        ...
        device = "mps" if __name__ == "__main__"  else "cpu"
        with torch.no_grad():
    ...
    def load(self):
        dev = "mps" if __name__ == "__main__"  else "cpu"
        ...
        while episode < max_episode:
            ...
            if done or trunc:
                ...
                if validation_score > 2e10: 
                    population_score = evaluate_HIV_population(agent=self, nb_episode=10)
                    if population_score > 2e10: 
